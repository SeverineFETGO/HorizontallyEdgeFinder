...
/* *****************CREATED BY SEVERINE FETGO 08/08/2020 ************* */
/*         ********* severine.fetgo@gmil.com ********************** */
/*
                     Fetgo Betmbe Sévérine, Tayou Djamegni Clémentin.
         " Horizontally Elastic Edge-Finder for Cumulative Resource Constraint Revisited”
             accepted for publication to CARI 2020 https://www.cari-info.org/.
...
public class RevisitedEdgeFinderConstraint extends AdjustmentsPropagator {
    ...
    public RevisitedEdgeFinderConstraint(IntVar[] startingTimes_makespan, IntVar[] endingTimes, Integer[] heights, Integer[] processingTimes, int capacity) {
    ...
    public void propagate(int evtmask) throws ContradictionException {
        ...
        do
        {
            ...
            RevisitedEdgeFinder ef = new RevisitedEdgeFinder(tasks, capacity);
            RevisitedEdgeFinder ef_negative = new RevisitedEdgeFinder(negativeTasks, capacity);
