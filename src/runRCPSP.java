...
public class runRCPSP {
    ...
    private static final int Severine_HEEF = 3;
    private static final int Severine_CubicHEEF = 4;
    private static final int Severine_All = 2;
    private static final int Roger_HEEF=1;
/*	private static final int New_New_Not_First = 2;
	...
	/*private static final int Dynamic_Branch_MDLBS = 2;
...
*/
	...
	//public runRCPSP(String fileName) throws Exception {
        ...
        //On pose la contrainte indiquant que la première tâche (une tâche dummy) doit commencer au temps 0
        ...
        if(indices.size() != 0){
            ...
            for(int j=0; j<indices.size(); j++)
            {
                ...
                //Variables nécessaires pour notre contrainte
                ...
                //Variables nécessaire pour la contrainte Cumulative de Choco
            ...
            //On crée la contrainte et son propagateur

            switch(propagator_type)
            {
            	case Vincent_HEEF:
            	Constraint myConstraint_Vincent = new Constraint("Vincent_Horizontally_Elastic_Edge_Finder",
            ...
            break;
           /* case Severine_HEEF:
            	Constraint myConstraint_Severine = new Constraint("Severine_Horiontally_Edge_Finding",
                        propagators[i] = new NewEdgeFinderConstraint(
                                filtered_startingTimes_makespan,
                                filtered_endingTimes,
                                filtered_heights,
                                filtered_processingTimes,
            	...
            	model.post(myConstraint_Severine);
                break;*/
                /*case Severine_CubicHEEF:
                    Constraint myConstraint_CubicSeverine = new Constraint("Severine_CubicHoriontally_Edge_Finding",
                    ...
                    model.post(myConstraint_CubicSeverine);
                    break;*/
             /*   case Severine_All:
                    Constraint myConstraint_SeverineAll = new Constraint("Severine_Edge_Finding_OnePhase",
                    ...
                    model.post(myConstraint_SeverineAll);
                    break;*/
                case Roger_HEEF:
                    Constraint myConstraint_Roger = new Constraint("Roger_Horizontally_Elastic_Edge_Finder",
