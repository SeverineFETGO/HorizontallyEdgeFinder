...
class Task implements Comparable<Task> {
  ...
  /*  public HTimepoint est_to_htimepoint;
    public HTimepoint ect_to_htimepoint;
    public HTimepoint lct_to_htimepoint;
    //public HTimepoint lst_to_htimepoint;
    
    
    public TTimepoint est_to_ttimepoint;
    public TTimepoint ect_to_ttimepoint;
    public TTimepoint lct_to_ttimepoint;
    public TTimepoint lst_to_ttimepoint;
    ...
    */
    ...
    public static class ComparatorByHeightByLct implements Comparator<Integer> {
        ...
        public int compare(Integer a, Integer b) {
            ...
            }else return tasks[a.intValue()].height() - tasks[b.intValue()].height();

        }
    }


    public static class ComparatorByHeightByReverseLct implements Comparator<Integer> {
        private  Task[] tasks;

        public ComparatorByHeightByReverseLct( Task[] list_of_tasks) {
